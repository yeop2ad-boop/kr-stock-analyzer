...
function ensureExtraDataLoaded(market) {
  ...
  const src = market === "domestic" ? "data/kr-data-extra.js?v=20260904g" : "data/sp500-data-extra.js?v=20260904g";
...
function ensureEtfCryptoDataLoaded() {
  ...
  const src = "data/etf-crypto-map.js?v=20260904g";
...
const METRIC_DESCS = {
  ...
  ret10yAvg: "최근 10년 전체 상승률을 상장 연수(최대 10년)로 나눈 연평균 상승률이에요.",
